          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px] ">
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px] ">
                ...
                <p className="text-[16px] leading-7  text-textColor font-[400] mt-5 text-center ">
                  World-class care for everyone. Our health System offers
                  unmatched, experte health care.From the lab to the clinic.
                </p>
                <Link
                  to="/doctors"
            ...
            <div className="xl:w-[670px] ">
              ...
              <ul className="pl-4">
                <li className="text__para">
                  1. Schedule de appointment directly
                </li>
                <li className="text__para">
              ...
              <div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:px-4 lg:pb-[26px] rounded-[10px]">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-[6px] lg:gap-3">
                    ...
                    <p className="text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-text font-[400]">
                      10:00AM
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px] ">
                  ...
                  <h4 className="text-[10px] leading-3 lg:text-[16px] lg:leeding-[22px] font-[700] text-headingColor ">
                    Wayne Collins
                  </h4>
                </div>
              </div>
